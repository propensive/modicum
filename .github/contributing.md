...
# Contributing to Modicum

Firstly, thank you for taking an interesting in contributing! Modicum is an
...
Modicum is one of a large number of
...
issue](https://github.com/propensive/modicum/issues) or contact the project
...
have commit rights to the `propensive/modicum` repository, push to a branch named
...
in extreme cases. Modicum does not use automatic code-formatting because it
...
Modicum&rsquo;s users. Individualism is valued, and nobody should feel
